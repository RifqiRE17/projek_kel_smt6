                    ...
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                        ...
                        @foreach ($data2 as $item2)
                            <div class="col-6 text-start">
                                <img class="img-fluid w-100" src="{{asset('img/aboutstart/'.$item2->gambar1)}}">
                            </div>
                            <div class="col-6 text-start">
                                <img class="img-fluid" src="{{asset('img/aboutstart/'.$item2->gambar2)}}" style="width: 85%; margin-top: 15%;">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid" src="{{asset('img/aboutstart/'.$item2->gambar3)}}" style="width: 85%;">
                            </div>
                            <div class="col-6 text-end">
                                <img class="img-fluid w-100" src="{{asset('img/aboutstart/'.$item2->gambar4)}}">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                        <h1 class="mb-4">{{$item2->judul}}</h1>
                        <p class="mb-4">{{$item2->isi}}</p>
